...
class Plateau{
    ...
    public Plateau (boolean cheat)
	{
		...
		if (cheat != true) // si c'est faux , ajout des pièces classiques
		{
		...
		else // sinon ajout des tavaliers et favaliers .
		{
			this.ajouterPiece(new Tour('B', new Position("A1")));
			this.ajouterPiece(new Cavalier('B', new Position("B1")));
			this.ajouterPiece(new Tavalier('B', new Position("C1")));
			this.ajouterPiece(new Favalier('B', new Position("D1")));
			this.ajouterPiece(new Favalier('B', new Position("E1")));
			...
			this.ajouterPiece(new Favalier('N', new Position("D8")));
			this.ajouterPiece(new Favalier('N', new Position("E8")));
